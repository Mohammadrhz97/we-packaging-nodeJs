...
export default function ProductListClient() {
  return (
    <div className="max-w-[1024px] mx-auto pt-4">
      {/* Page header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-8 max-w-full justify-items-center place-content-between mx-5 bg-white/5 backdrop-blur-xs shadow-[0_0_30px_rgba(255,255,255,0.15)] p-5 rounded-lg">
