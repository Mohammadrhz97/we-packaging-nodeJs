          ...
          <div className="relative">
            ...
            <Link href="/products">
              <div className="absolute sm:hidden w-full top-0 backdrop-blur-xs h-16 flex justify-center items-center">
                <button className="backdrop-blur-xs flex items-center h-11 justify-center text-white md:text-xl text-md gap-4 border border-black border-opacity-60 border-r-3 border-b-3 p-1 px-3 z-30 cursor-pointer">
                  <span>
